  ...
  void renderMarker(
    ...
    if (seriesRendererDetails.chart.onMarkerRender != null &&
      ...
      if (animationController == null ||
          ((animationController.value == 0.0 &&
                  !point.isMarkerEventTriggered &&
                  animationController.status == AnimationStatus.forward) ||
              (seriesRendererDetails
                          .animationController.duration!.inMilliseconds ==
                      0 &&
                  !point.isMarkerEventTriggered))) {
        point.isMarkerEventTriggered = true;
        ...
        point.markerDetails = MarkerDetails(
    ...
    !isBoxSeries
        ? seriesRendererDetails.markerShapes.add(isDataPointVisible
            ? getMarkerShapesPath(
                point.markerDetails?.markerType ?? markerType,
                Offset(point.markerPoint!.x, point.markerPoint!.y),
                point.markerDetails?.size ?? size,
                seriesRendererDetails,
                markerIndex,
                null,
                animationController)
    ...
    strokePaint = Paint()
      ..color = point.isEmpty == true
          ...
          : (series.markerSettings.borderWidth == 0
              ? Colors.transparent
              : (point.markerDetails?.borderColor != null
                  ? point.markerDetails!.borderColor!.withOpacity(opacity)
      ...
      ..strokeWidth = point.isEmpty == true
          ...
          : point.markerDetails?.borderWidth ?? borderWidth;

    if (series.gradient != null &&
        series.markerSettings.borderColor == null &&
        ((point.markerDetails == null) ||
            (point.markerDetails != null &&
                point.markerDetails!.borderColor == null))) {
      ...
      strokePaint.strokeWidth = point.isEmpty == true
          ? series.emptyPointSettings.borderWidth
          : point.markerDetails?.borderWidth ??
